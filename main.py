...
def query_data(request: QueryRequest):
    try:
        ...
        # 모델 리스트
        origin_model = ['llama3-70b-8192', 'mixtral-8x7b-32768', 'llama3-8b-8192', 'gemma-7b-it']

        # 활성화된 모델만 포함하는 리스트를 생성합니다.
        active_models = [model for model in origin_model if any(m['id'] == model and m['active'] for m in models['data'])]
